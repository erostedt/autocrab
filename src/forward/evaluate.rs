...
pub type ObjectiveFunction<const VARIABLE_COUNT: usize> =
    fn(variables: [Variable; VARIABLE_COUNT]) -> Variable;

pub fn evaluate<const VARIABLE_COUNT: usize>(
    function: ObjectiveFunction<VARIABLE_COUNT>,
    x: [f64; VARIABLE_COUNT],
) -> (f64, [f64; VARIABLE_COUNT])
{
    let mut value = 0.0;
